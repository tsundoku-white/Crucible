...
Crucible is a library for one who is looking for a way to program in c++.
...
- Git
- C++ 23/26 
> **Note** there is install scripts in install/ for both linux and windows 10+.
> **Note** unfortunaly by windows compiler MSVC only support c++ 23 so might break.
